...
class RequirementsRenewFormPage extends StatefulWidget {
  final void Function(String, String, int, String, int, String) onNextStep;
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      listeners: [
        ...
        BlocListener<OrfProofPicBloc, OrfProofPicState>(
          listener: (context, state) {},
        ),
      ],
      child: BlocBuilder<OrfProofPicBloc, OrfProofPicState>(
        builder: (context, state) {
          String? orfUrl;
          if (state is OrfProofPicStateSuccess) {
            orfUrl = state.imageOrfUrl;
          }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.only(left: 4),
                              child: Text(
                                'Please provide your ORF (Official Receipt Form) image link',
                                style: GoogleFonts.nunito(
                                  fontSize: 14,
                            ...
                            Row(
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    context
                                        .read<OrfProofPicBloc>()
                                        .add(OrfProofPicPickerEvent());
                                  },
                                  child: Container(
